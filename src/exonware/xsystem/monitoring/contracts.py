...
Monitoring protocol interfaces for XSystem.
"""
...
class IPerformance(ABC):
    ...
    Enforces consistent performance monitoring across XSystem.
    """
...
class IMonitorable(ABC):
    ...
    Enforces consistent monitoring behavior across XSystem.
    """
...
class IMetrics(ABC):
    ...
    Enforces consistent metrics behavior across XSystem.
    """
...
class IHealthCheck(ABC):
    ...
    Enforces consistent health checking across XSystem.
    """
...
class IAlerting(ABC):
    ...
    Enforces consistent alerting behavior across XSystem.
    """
...
class ISystemMonitor(ABC):
    ...
    Enforces consistent system monitoring across XSystem.
    """
...
class IProfiler(ABC):
    ...
    Enforces consistent profiling behavior across XSystem.
    """
...
class IMonitoringConfig(ABC):
    ...
    Enforces consistent monitoring configuration across XSystem.
    """
