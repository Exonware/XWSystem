...
Plugin protocol interfaces for XSystem.
"""
...
class IPlugin(ABC):
    ...
    Enforces consistent plugin behavior across XSystem.
    """
...
class IExtensible(ABC):
    ...
    Enforces consistent extension behavior across XSystem.
    """
...
class IHookable(ABC):
    ...
    Enforces consistent hook behavior across XSystem.
    """
...
class IPluginManager(ABC):
    ...
    Enforces consistent plugin management across XSystem.
    """
...
class IPluginRegistry(ABC):
    ...
    Enforces consistent plugin registration across XSystem.
    """
...
class IPluginDiscovery(ABC):
    ...
    Enforces consistent plugin discovery across XSystem.
    """
...
class IPluginConfig(ABC):
    ...
    Enforces consistent plugin configuration across XSystem.
    """
...
class IPluginEvents(ABC):
    ...
    Enforces consistent plugin event handling across XSystem.
    """
...
class IPluginDependency(ABC):
    ...
    Enforces consistent plugin dependency handling across XSystem.
    """
