...
Core protocol interfaces for XSystem.
"""
...
class DataType(Enum):
    """Core data types supported by XSystem."""
    STRING = "string"
    INTEGER = "integer"
    FLOAT = "float"
    BOOLEAN = "boolean"
...
class IID(ABC):
    ...
    Enforces consistent ID management across XSystem components.
    """
...
class INative(ABC):
    ...
    Enforces consistent native data conversion across XSystem.
    """
...
class ICloneable(ABC):
    ...
    Enforces consistent cloning behavior across XSystem.
    """
...
class IComparable(ABC):
    ...
    Enforces consistent comparison behavior across XSystem.
    """
...
class IIterable(ABC):
    ...
    Enforces consistent iteration behavior across XSystem.
    """
...
class IContainer(ABC):
    ...
    Enforces consistent container behavior across XSystem.
    """
...
class IMetadata(ABC):
    ...
    Enforces consistent metadata handling across XSystem.
    """
...
class ILifecycle(ABC):
    ...
    Enforces consistent lifecycle behavior across XSystem.
    """
...
class IFactory(ABC):
    ...
    Enforces consistent factory behavior across XSystem.
    """
