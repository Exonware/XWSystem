...
Validation protocol interfaces for XSystem.
"""
...
class IValidatable(ABC):
    ...
    Enforces consistent validation behavior across XSystem.
    """
...
class IValidationManager(ABC):
    ...
    Enforces consistent validation management across XSystem.
    """
...
class ISchemaValidator(ABC):
    ...
    Enforces consistent schema validation across XSystem.
    """
