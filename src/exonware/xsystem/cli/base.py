...
class BaseCLI(ICLI):
    ...
    def __init__(self, name: str = "xsystem", version: str = "0.0.1"):
        """Initialize the CLI.
    ...
    def get_help(self) -> str:
        """Get help text."""
        return f"{self._name} v{self._version} - xSystem CLI"
...
class BaseCLI(ICLI):
    ...
    def get_help(self) -> str:
        """Get help text."""
        help_text = f"{self._name} v{self._version} - xSystem CLI\n\n"
