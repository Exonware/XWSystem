#!/usr/bin/env python3
#exonware\xsystem\serialization\contracts.py
"""
...
Serialization interfaces for XSystem.
"""

from abc import ABC, abstractmethod
from pathlib import Path
from typing import Any, AsyncIterator, BinaryIO, Dict, List, Optional, TextIO, Union, Protocol
...
class ISerializable(ABC):
    ...
    Enforces consistent serialization across XSystem.
    """
...
class ISerializationManager(ABC):
    ...
    Enforces consistent serialization management across XSystem.
    """
...
class ISerializationValidator(ABC):
    ...
    Enforces consistent serialization validation across XSystem.
    """
