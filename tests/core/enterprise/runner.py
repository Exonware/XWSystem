#exonware/xsystem/tests/core/enterprise/runner.py
"""
...
def main():
    ...
    try:
        import sys
        from pathlib import Path
        test_basic_path = Path(__file__).parent / "test_core_xsystem_enterprise.py"
        sys.path.insert(0, str(test_basic_path.parent))

        import test_core_xsystem_enterprise
        return test_core_xsystem_enterprise.main()
