...
class SerializationCoreTester:
    ...
    def test_json_serialization(self) -> bool:
        ...
        try:
            from exonware.xsystem.serialization.json import JsonSerializer, save_file, load_file
    ...
    def test_basic_serialization(self) -> bool:
        ...
        try:
            from exonware.xsystem.serialization.json import dumps, loads
    ...
    def test_convenience_functions(self) -> bool:
        ...
        try:
            from exonware.xsystem import quick_serialize, quick_deserialize
    ...
    def test_all_serialization_tests(self) -> int:
        ...
        try:
            import sys
            from pathlib import Path
            test_xsystem_path = Path(__file__).parent / "test_core_xsystem_serialization.py"
            sys.path.insert(0, str(test_xsystem_path.parent))
            
            import test_core_xsystem_serialization
            return test_core_xsystem_serialization.main()
        except Exception as e:
