#exonware/xsystem/tests/core/patterns/test_core_xsystem_patterns.py
"""
...
try:
    from exonware.xsystem.patterns.context_manager import ContextManager
    from exonware.xsystem.patterns.dynamic_facade import DynamicFacade
    from exonware.xsystem.patterns.handler_factory import HandlerFactory
    from exonware.xsystem.patterns.import_registry import ImportRegistry
    from exonware.xsystem.patterns.object_pool import ObjectPool
    from exonware.xsystem.patterns.base import BasePattern
    from exonware.xsystem.patterns.contracts import IContextManager, IDynamicFacade, IHandlerFactory, IObjectPool
    from exonware.xsystem.patterns.errors import PatternError, ContextError, FacadeError, FactoryError, PoolError
