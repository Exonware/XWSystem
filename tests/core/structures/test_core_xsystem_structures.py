#exonware/xsystem/tests/core/structures/test_core_xsystem_structures.py
"""
...
try:
    from exonware.xsystem.structures.circular_detector import CircularDetector
    from exonware.xsystem.structures.tree_walker import TreeWalker
    from exonware.xsystem.structures.base import BaseStructure
    from exonware.xsystem.structures.contracts import ICircularDetector, ITreeWalker
    from exonware.xsystem.structures.errors import StructureError, CircularReferenceError, TreeError
