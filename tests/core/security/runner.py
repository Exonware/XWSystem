...
class SecurityCoreTester:
    ...
    def test_symmetric_encryption(self) -> bool:
        ...
        try:
            from exonware.xsystem.security.crypto import SymmetricEncryption
    ...
    def test_password_hashing(self) -> bool:
        ...
        try:
            from exonware.xsystem.security.crypto import hash_password, verify_password
    ...
    def test_secure_random(self) -> bool:
        ...
        try:
            from exonware.xsystem.security.crypto import SecureRandom
    ...
    def test_convenience_functions(self) -> bool:
        ...
        try:
            from exonware.xsystem import quick_hash, quick_encrypt, quick_decrypt
    ...
    def test_all_security_tests(self) -> int:
        ...
        try:
            import sys
            from pathlib import Path
            test_basic_path = Path(__file__).parent / "test_core_xsystem_security.py"
            sys.path.insert(0, str(test_basic_path.parent))
            
            import test_core_xsystem_security
            return test_core_xsystem_security.main()
        except Exception as e:
