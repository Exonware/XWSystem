#exonware/xsystem/tests/core/plugins/test_core_xsystem_plugins.py
"""
...
try:
    from exonware.xsystem.plugins.base import BasePlugin
    from exonware.xsystem.plugins.contracts import IPlugin
    from exonware.xsystem.plugins.errors import PluginError
