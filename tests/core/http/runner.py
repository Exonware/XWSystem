...
class HttpCoreTester:
    ...
    def test_http_client_basic(self) -> bool:
        ...
        try:
            from exonware.xsystem.http.client import HttpClient
    ...
    def test_retry_config(self) -> bool:
        ...
        try:
            from exonware.xsystem.http.client import RetryConfig
    ...
    def test_async_http_client(self) -> bool:
        ...
        try:
            from exonware.xsystem.http.client import AsyncHttpClient
    ...
    def test_advanced_http_client(self) -> bool:
        ...
        try:
            from exonware.xsystem.http.advanced_client import AdvancedHttpClient, AdvancedHttpConfig
    ...
    def test_http_error_handling(self) -> bool:
        ...
        try:
            from exonware.xsystem.http.client import HttpClient
            from exonware.xsystem.http.errors import HttpError
    ...
    def test_all_http_tests(self) -> int:
        ...
        try:
            ...
            test_basic_path = Path(__file__).parent / "test_core_xsystem_http.py"
            sys.path.insert(0, str(test_basic_path.parent))
            
            import test_core_xsystem_http
            return test_core_xsystem_http.main()
        except Exception as e:
