...
class CachingCoreTester:
    ...
    def test_lfu_cache(self) -> bool:
        ...
        try:
            from exonware.xsystem.caching.lfu_cache import LFUCache
    ...
    def test_ttl_cache(self) -> bool:
        ...
        try:
            from exonware.xsystem.caching.ttl_cache import TTLCache
    ...
    def test_async_lru_cache(self) -> bool:
        ...
        try:
            from exonware.xsystem.caching.lru_cache import AsyncLRUCache
    ...
    def test_async_lfu_cache(self) -> bool:
        ...
        try:
            from exonware.xsystem.caching.lfu_cache import AsyncLFUCache
    ...
    def test_async_ttl_cache(self) -> bool:
        ...
        try:
            from exonware.xsystem.caching.ttl_cache import AsyncTTLCache
    ...
    def test_cache_manager(self) -> bool:
        ...
        try:
            from exonware.xsystem.caching.cache_manager import CacheManager, CacheConfig
    ...
    def test_all_caching_tests(self) -> int:
        ...
        try:
            ...
            test_basic_path = Path(__file__).parent / "test_core_xsystem_caching.py"
            sys.path.insert(0, str(test_basic_path.parent))
            
            import test_core_xsystem_caching
            return test_core_xsystem_caching.main()
        except Exception as e:
