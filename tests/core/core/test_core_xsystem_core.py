#exonware/xsystem/tests/core/core/test_core_xsystem_core.py
"""
...
try:
    from exonware.xsystem.core.base import BaseCore
    from exonware.xsystem.core.contracts import ICore
    from exonware.xsystem.core.errors import CoreError
