#exonware/xsystem/tests/core/performance/runner.py
"""
...
def main():
    ...
    try:
        import sys
        from pathlib import Path
        test_basic_path = Path(__file__).parent / "test_core_xsystem_performance.py"
        sys.path.insert(0, str(test_basic_path.parent))

        import test_core_xsystem_performance
        return test_core_xsystem_performance.main()
