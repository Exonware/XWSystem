#exonware/xsystem/tests/core/performance/test_core_xsystem_performance.py
"""
...
try:
    from exonware.xsystem.performance.manager import PerformanceManager
    from exonware.xsystem.performance.base import BasePerformance
    from exonware.xsystem.performance.contracts import IPerformanceManager
    from exonware.xsystem.performance.errors import PerformanceError
