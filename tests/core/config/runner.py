#exonware/xsystem/tests/core/config/runner.py
"""
...
def main():
    ...
    try:
        import sys
        from pathlib import Path
        test_basic_path = Path(__file__).parent / "test_core_xsystem_config.py"
        sys.path.insert(0, str(test_basic_path.parent))

        import test_core_xsystem_config
        return test_core_xsystem_config.main()
