#exonware/xsystem/tests/core/config/test_core_xsystem_config.py
"""
...
try:
    from exonware.xsystem.config.defaults import DefaultConfig
    from exonware.xsystem.config.performance_modes import PerformanceModes
    from exonware.xsystem.config.performance import PerformanceConfig
    from exonware.xsystem.config.logging_setup import LoggingSetup
    from exonware.xsystem.config.logging import LoggingConfig
    from exonware.xsystem.config.base import BaseConfig
    from exonware.xsystem.config.contracts import IConfig, IPerformanceConfig, ILoggingConfig
    from exonware.xsystem.config.errors import ConfigError, PerformanceError, LoggingError
except ImportError as e:
    print(f"Import error: {e}")
    # Create mock classes for testing
    class DefaultConfig:
        def __init__(self): pass
        def get_default(self, key): return "default_value"
        def set_default(self, key, value): pass
