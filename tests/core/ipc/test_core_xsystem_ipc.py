#exonware/xsystem/tests/core/ipc/test_core_xsystem_ipc.py
"""
...
try:
    from exonware.xsystem.ipc.message_queue import MessageQueue
    from exonware.xsystem.ipc.pipes import PipeManager
    from exonware.xsystem.ipc.process_manager import ProcessManager
    from exonware.xsystem.ipc.process_pool import ProcessPool
    from exonware.xsystem.ipc.shared_memory import SharedMemory
    from exonware.xsystem.ipc.base import BaseIPC
    from exonware.xsystem.ipc.contracts import IMessageQueue, IPipeManager, IProcessManager, ISharedMemory
    from exonware.xsystem.ipc.errors import IPCError, MessageQueueError, PipeError, ProcessError, SharedMemoryError
