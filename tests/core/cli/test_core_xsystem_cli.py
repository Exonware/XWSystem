#exonware/xsystem/tests/core/cli/test_core_xsystem_cli.py
"""
...
try:
    from exonware.xsystem.cli.console import Console
    from exonware.xsystem.cli.progress import ProgressBar
    from exonware.xsystem.cli.prompts import Prompts
    from exonware.xsystem.cli.tables import TableFormatter
    from exonware.xsystem.cli.args import ArgumentParser
    from exonware.xsystem.cli.colors import Colors
    from exonware.xsystem.cli.base import BaseCLI
    from exonware.xsystem.cli.contracts import ICLI, IProgress, IPrompts, ITableFormatter
    from exonware.xsystem.cli.errors import CLIError, ConsoleError, ProgressError
